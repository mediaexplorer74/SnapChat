...
namespace SnapChat
{
    ...
    {
        private const string APIKey = "sTdykEmtfJsTQmafUMxrKalcdkaphW67";
        ...
        private static async Task RegisterPushChannelAsync()
        {
            ...
            //RnD
            //MobileService.GetPush()..RegisterNativeAsync(channel.Uri, new[] 
            //await MobileService.GetPush().RegisterAsync(channel.Uri, 
            //    /*new[]{ "SnapDotNetUser", App.DeviceIdent }*/null);
